...
<body>
    ...
    <div class="copyright">COPYRIGHT INFRINGEMENT POLICY
    MR Respects the intellectual property rights of others. If you believe that your work has been copied in a way that constitutes copyright infringement, please provide Freelancer's Copyright Agent with the information specified below in the form of a "Notification of Alleged Infringement." It is Freelancer's policy to respond to clear Notifications of Alleged Infringement, and our policy is designed to make submitting Notifications of Alleged Infringement as straightforward as possible while reducing the number of Notifications that we receive that are fraudulent or difficult to understand or verify. If you are a User (as defined in the User Agreement at https://www.freelancer.com/about/terms) or subscriber and concerned about the removal of or blocked access to your content, please provide Freelancer's Copyright Agent with the written information specified below in the form of a "Counter-Notification." The forms specified below are consistent with the forms suggested by the United States Digital Millennium Copyright Act (the text of which can be found at the U.S. Copyright Office Website at http://www.copyright.gov).
        
        DMCA NOTIFICATION OF ALLEGED COPYRIGHT INFRINGEMENT
        If you would like to submit a claim of copyright infringement for material, please substantiate each claim by sending Freelancer's registered Copyright Agent a Notification of Claimed Infringement at the email or mailing address below:
        
        Copyright Agent c/o MR, Level 37, Grosvenor Place, 225 George Street, Sydney, New South Wales 2000, Australia copyright@freelancer.com
        ...
        Information reasonably sufficient to permit MR to locate the material that is claimed to be infringing or to be the subject of infringing activity
        Information reasonably sufficient to permit MR to contact person submitting the Notification, such as a physical address, email address, and telephone number
        ...
        Copyright Agent c/o Freelancer, Level 37, Grosvenor Place, 225 George Street, Sydney, New South Wales, Australia 2000 copyright@freelancer.com
